namespace Xperience.Core.Breadcrumbs
{
    public interface IBreadcrumbsRenderer
    {
        ...
        /// </summary>
        public abstract string RenderCurrentPage(BreadcrumbItem bci);
        ...
        /// </summary>
        public abstract string RenderSiteLink(BreadcrumbItem bci);

        /// <summary>
        /// Renders a standard breadcrumb item which contains a link
        /// </summary>
        public abstract string RenderItem(BreadcrumbItem bci);

        /// <summary>
        /// Renders a breadcrumb item that doesn't contain a link
        /// </summary>
        public abstract string RenderItemWithoutLink(BreadcrumbItem bci);
    }
}
